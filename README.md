...
* Data para entrega final do projeto: `21/11/2023 23:59`.
...
* Use o comando: `git clone git@github.com:tryber/sd-037-project-iChoveu.git`.
* Entre na pasta do repositório que você acabou de clonar:
  * `cd sd-037-project-iChoveu`
...
* Agora, crie uma branch à qual você vai submeter os `commits` de seu projeto
  ...
  * Exemplo: `git checkout -b joaozinho-sd-037-project-iChoveu`
...
* Usando o exemplo anterior: `git push -u origin joaozinho-sd-037-project-iChoveu`

  6. Crie um `Pull Request` _(PR)_

* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-037-project-iChoveu/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-037-project-iChoveu/pulls) e confira se seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH37&template=betrybe/sd-0x-project-iChoveu)
